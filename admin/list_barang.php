                                            ...
                                            <form action="../prosesdata/process_tambah_barang.php" method="POST">
                                                <div class="grid grid-cols-12 sm:gap-x-6 gap-y-3">
                                                    ...
                                                    <div class="xl:col-span-3 col-span-12">
                                                        ...
                                                        <input type="text" class="ti-form-control flatpickr" name="expire" placeholder="YYYY-MM-DD" required>
                                                    </div>
                                                    <!-- Batch Number -->
                                                    <div class="xl:col-span-3 col-span-12">
                            ...
                            <table class="scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-200 table border border-defaultborder dark:border-defaultborder/10 text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <?php 
                                        ...
                                        $expire_data_json = $farma->daysUntilExpire($produk['expiry_date']);
                                        $expire_data = json_decode($expire_data_json, true);
                                        
                                        // Initialize days_left to a default value (e.g., 0 for expired or error)
                                        $days_left = 0; 

                                        if ($expire_data !== null && isset($expire_data['days_left']) && is_numeric($expire_data['days_left'])) {
                                            $days_left = (int)$expire_data['days_left'];
                                            // If days_left is negative (e.g., product expired 5 days ago, days_left = -5),
                                            // set to 0 for display consistency (e.g., "0 hari" instead of "-5 hari").
                                            // The badge logic will correctly handle $days_left <= 0 as critical/expired.
                                            if ($days_left < 0) {
                                                $days_left = 0;
                                            }
                                        }
                                        // If $expire_data is null (e.g., json_decode failed or the method returned an error indicator)
                                        // or if 'days_left' is not set or is not a numeric value,
                                        // $days_left will retain its initialized value of 0.
                                        // If json_decode fails (e.g., $produk['expiry_date'] is problematic causing daysUntilExpire to return non-JSON),
                                        // $expire_data will be null, and $days_left will also remain the default 0.
                                                    ...
                                                    <div class="ti-modal-body">
                                                        <form action="../prosesdata/process_edit_barang.php" method="POST">
                                                            ...
                                                            <div class="grid grid-cols-12 sm:gap-x-6 gap-y-3">
                                                                ...
                                                                <div class="xl:col-span-3 col-span-12">
                                                                    <label class="ti-form-label">Expire</label>
                                                                    <input type="text" class="ti-form-control flatpickr" name="expire" value="<?php echo htmlspecialchars($produk['expiry_date']); ?>" placeholder="YYYY-MM-DD" required />
                                                                </div>
                                                                <!-- Batch Number -->
                                                                <div class="xl:col-span-3 col-span-12">
                                                                    <label class="ti-form-label">Batch Number</label>
                                                                ...
                                                                <!-- Stok -->
                                                                <!-- Jumlah Stok (target value) -->
                                                                <div class="xl:col-span-3 col-span-12">
                                                                    <label class="ti-form-label">Jumlah Stok</label>
                                                                    <input type="number" class="ti-form-control" id="stok_barang_<?php echo $produk['product_id']; ?>" name="stok_barang" value="<?php echo htmlspecialchars($produk['stock_quantity']); ?>" required min="0" />
                                                                </div>

                                                                <!-- Penyesuaian Stok -->
                                                                <div class="xl:col-span-6 col-span-12">
                                                                    <label class="ti-form-label">Penyesuaian Stok</label>
                                                                    <div class="space-y-2">
                                                                        <div>
                                                                            <input type="number" class="ti-form-control" id="jumlah_penyesuaian_<?php echo $produk['product_id']; ?>" placeholder="Jumlah" min="1">
                                                                        </div>
                                                                        <div class="flex items-center space-x-4">
                                                                            <div class="flex items-center">
                                                                                <input type="checkbox" class="ti-form-checkbox" id="cb_tambah_stok_<?php echo $produk['product_id']; ?>" 
                                                                                       onclick="processStockAdjustment('tambah', '<?php echo $produk['product_id']; ?>')">
                                                                                <label for="cb_tambah_stok_<?php echo $produk['product_id']; ?>" class="text-sm text-gray-500 ms-2 dark:text-white/70">Tambah</label>
                                                                            </div>
                                                                            <div class="flex items-center">
                                                                                <input type="checkbox" class="ti-form-checkbox" id="cb_kurang_stok_<?php echo $produk['product_id']; ?>" 
                                                                                       onclick="processStockAdjustment('kurang', '<?php echo $produk['product_id']; ?>')">
                                                                                <label for="cb_kurang_stok_<?php echo $produk['product_id']; ?>" class="text-sm text-gray-500 ms-2 dark:text-white/70">Kurang</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <p class="text-xs text-textmuted dark:text-textmuted/50 mt-1">Masukkan jumlah, lalu centang aksi. 'Jumlah Stok' akan diupdate.</p>
                                                                </div>
...
<html lang="en" dir="ltr" data-nav-layout="vertical" class="light" data-header-styles="light" data-menu-styles="light" data-width="fullwidth" data-toggled="close">
    ...
    <body>
        ...
        <script>
            ...
            function processStockAdjustment(action, productId) {
                                                                            const stokBarangInput = document.getElementById(`stok_barang_${productId}`);
                                                                            const jumlahPenyesuaianInput = document.getElementById(`jumlah_penyesuaian_${productId}`);
                                                                            const cbTambah = document.getElementById(`cb_tambah_stok_${productId}`);
                                                                            const cbKurang = document.getElementById(`cb_kurang_stok_${productId}`);

                                                                            let currentStock = parseInt(stokBarangInput.value) || 0;
                                                                            let adjustmentAmount = parseInt(jumlahPenyesuaianInput.value) || 0;

                                                                            if (adjustmentAmount <= 0 && (cbTambah.checked || cbKurang.checked)) {
                                                                                // If adjustment amount is not valid, reset checkboxes and do nothing
                                                                                if (action === 'tambah') cbTambah.checked = false;
                                                                                if (action === 'kurang') cbKurang.checked = false;
                                                                            ...
                                                                            if (action === 'tambah' && cbTambah.checked) {
                                                                                cbKurang.checked = false;
                                                                                currentStock += adjustmentAmount;
                                                                            } else if (action === 'kurang' && cbKurang.checked) {
                                                                                cbTambah.checked = false;
                                                                                currentStock -= adjustmentAmount;
                                                                                if (currentStock < 0) {
                                                                                    currentStock = 0; // Prevent stock from going negative
                                                                                }
                                                                            } else {
                                                                                // If a checkbox is unchecked, revert to original stock or re-calculate if the other is checked
                                                                                // This logic might need refinement based on desired behavior when unchecking.
                                                                                // For simplicity, let's assume unchecking means "cancel this specific adjustment action".
                                                                                // To properly revert, we'd need to store the original stock before any adjustment.
                                                                                // A simpler approach for now: if both are unchecked, the stock_barang input reflects the last valid state.
                                                                                // Or, if unchecking, we might want to revert the last operation.
                                                                                // For now, let's just ensure the stock_barang_input reflects the current state based on checked boxes.
                                                                                
                                                                                // Re-fetch original stock if both are unchecked to reset
                                                                                // This requires storing the original value when the modal opens, which is more complex.
                                                                                // A simpler immediate fix: if unchecking, and the other is also unchecked,
                                                                                // we might need to re-fetch the original value or disable direct editing of stok_barang.

                                                                                // Let's adjust the logic: when a checkbox is clicked, calculate based on its state.
                                                                                // If it's unchecked, the effect of that action is removed.
                                                                                // This means we need to know the "base" stock before these UI adjustments.
                                                                                // The current `stok_barang_input.value` is the *target* value, not the *original* value.

                                                                                // Let's refine: the `stok_barang` input should be the *result* of adjustments.
                                                                                // When a checkbox is clicked, it either applies or (if unchecked) implies reverting its specific effect.
                                                                                // This can get complicated if both are toggled.

                                                                                // Simpler model:
                                                                                // 1. Get the *original* stock (value attribute when modal loaded).
                                                                                // 2. If "tambah" is checked, add adjustment.
                                                                                // 3. If "kurang" is checked, subtract adjustment.
                                                                                // This means we need the original stock value. Let's assume `data-original-stock` attribute.
                                                                                // For now, let's work with the current value and adjust based on the *last action*.

                                                                                // If a checkbox is unchecked, we need to revert its effect from the current stock value.
                                                                                // This is tricky because the `currentStock` variable is already modified.
                                                                                // A better way: recalculate from a base value each time.
                                                                                // Let's assume `stok_barang_input` holds the *current actual stock* and we are *proposing an adjustment*.
                                                                                // The `stok_barang` field should then be updated to reflect the *new proposed stock*.

                                                                                // Get the stock value *before* this specific click's adjustment
                                                                                let stockBeforeThisAdjustment = parseInt(stokBarangInput.dataset.lastStockValue || stokBarangInput.value) || 0;
                                                                                
                                                                                if (action === 'tambah' && !cbTambah.checked) { // Tambah was unchecked
                                                                                    // Revert addition: if cbKurang is not checked, it's original, else it's original - adjustment
                                                                                     currentStock = cbKurang.checked ? stockBeforeThisAdjustment - adjustmentAmount : stockBeforeThisAdjustment;
                                                                                } else if (action === 'kurang' && !cbKurang.checked) { // Kurang was unchecked
                                                                                    // Revert subtraction
                                                                                    currentStock = cbTambah.checked ? stockBeforeThisAdjustment + adjustmentAmount : stockBeforeThisAdjustment;
                                                                                }
                                                                            }
                                                                            
                                                                            // If both are unchecked, reset to original value (if we had it) or current value if no adjustment amount
                                                                            if (!cbTambah.checked && !cbKurang.checked && adjustmentAmount > 0) {
                                                                                 // This part is tricky without knowing the "original" stock before any checkbox was ticked.
                                                                                 // For now, if both are unchecked, the stock_barang field will retain the value from before the last uncheck.
                                                                                 // Or, we can try to revert the last action.
                                                                                 // Let's assume the `stok_barang` field is the one being *calculated*.
                                                                                 // We need a base stock. The `value` attribute of the input when the modal opens is the base.
                                                                                 const originalStock = parseInt(document.getElementById(`stok_barang_${productId}`).getAttribute('value'));
                                                                                 currentStock = originalStock;
                                                                                 if (cbTambah.checked && adjustmentAmount > 0) currentStock += adjustmentAmount;
                                                                                 if (cbKurang.checked && adjustmentAmount > 0) currentStock -= adjustmentAmount;

                                                                            }


                                                                            stokBarangInput.value = currentStock < 0 ? 0 : currentStock;
                                                                            stokBarangInput.dataset.lastStockValue = currentStock; // Store for potential revert

                                                                            // Clear adjustment input if both are unchecked or if amount is 0
                                                                            if ((!cbTambah.checked && !cbKurang.checked) || adjustmentAmount === 0) {
                                                                                // jumlahPenyesuaianInput.value = ''; // Optional: clear adjustment
                                                                            }
                                                                        }

                                                                        // Initialize flatpickr for existing and future modals
                                                                        document.addEventListener('DOMContentLoaded', function() {
                                                                            flatpickr(".flatpickr", {
                                                                                dateFormat: "Y-m-d",
                                                                            });

                                                                            // Add event listeners to quantity adjustment inputs to ensure only one checkbox is active
                                                                            const adjustmentSections = document.querySelectorAll('[id^="jumlah_penyesuaian_"]');
                                                                            adjustmentSections.forEach(input => {
                                                                                const productId = input.id.split('_').pop();
                                                                                const cbTambah = document.getElementById(`cb_tambah_stok_${productId}`);
                                                                                const cbKurang = document.getElementById(`cb_kurang_stok_${productId}`);
                                                                                const stokBarangInput = document.getElementById(`stok_barang_${productId}`);

                                                                                // Store original stock value when modal is shown (approximate)
                                                                                // A more robust way is to do this when HSOverlay shows the modal.
                                                                                if (stokBarangInput) {
                                                                                    stokBarangInput.dataset.originalStock = stokBarangInput.value;
                                                                                }


                                                                                if(cbTambah) {
                                                                                    cbTambah.addEventListener('click', function() {
                                                                                        if (this.checked) {
                                                                                            cbKurang.checked = false;
                                                                                        }
                                                                                        processStockAdjustment('tambah', productId);
                                                                                    });
                                                                                }

                                                                                if(cbKurang) {
                                                                                    cbKurang.addEventListener('click', function() {
                                                                                        if (this.checked) {
                                                                                            cbTambah.checked = false;
                                                                                        }
                                                                                        processStockAdjustment('kurang', productId);
                                                                                    });
                                                                                }
                                                                                // Recalculate if adjustment amount changes
                                                                                input.addEventListener('input', function() {
                                                                                    // Determine which action is active (if any) and re-process
                                                                                    if (cbTambah && cbTambah.checked) {
                                                                                        processStockAdjustment('tambah', productId);
                                                                                    } else if (cbKurang && cbKurang.checked) {
                                                                                        processStockAdjustment('kurang', productId);
                                                                                    } else {
                                                                                        // If neither is checked, but user types, reset stock to original
                                                                                         if (stokBarangInput && stokBarangInput.dataset.originalStock) {
                                                                                            stokBarangInput.value = stokBarangInput.dataset.originalStock;
                                                                                        }
                                                                                    }
                                                                                });
                                                                            });
                                                                        ...
                                                                        // Refined processStockAdjustment
                                                                        function processStockAdjustment(action, productId) {
                                                                            const stokBarangInput = document.getElementById(`stok_barang_${productId}`);
                                                                            const jumlahPenyesuaianInput = document.getElementById(`jumlah_penyesuaian_${productId}`);
                                                                            const cbTambah = document.getElementById(`cb_tambah_stok_${productId}`);
                                                                            ...
                                                                            // Ensure original stock is available
                                                                            if (!stokBarangInput.dataset.originalStock) {
                                                                                stokBarangInput.dataset.originalStock = stokBarangInput.value;
                                                                            }
                                                                            
                                                                            let originalStock = parseInt(stokBarangInput.dataset.originalStock) || 0;
                                                                            let adjustmentAmount = parseInt(jumlahPenyesuaianInput.value) || 0;
                                                                            let newStock = originalStock;

                                                                            if (adjustmentAmount < 0) adjustmentAmount = 0; // No negative adjustments

                                                                            if (cbTambah.checked && action === 'tambah') {
                                                                                cbKurang.checked = false; // Ensure other is unchecked
                                                                                if (adjustmentAmount > 0) {
                                                                                    newStock = originalStock + adjustmentAmount;
                                                                                }
                                                                            } else if (cbKurang.checked && action === 'kurang') {
                                                                                cbTambah.checked = false; // Ensure other is unchecked
                                                                                if (adjustmentAmount > 0) {
                                                                                    newStock = originalStock - adjustmentAmount;
                                                                                }
                                                                            } else if (!cbTambah.checked && !cbKurang.checked) {
                                                                                // If both are unchecked, stock should be the original stock
                                                                                newStock = originalStock;
                                                                            } else if (cbTambah.checked && adjustmentAmount > 0) { // Recalculate if only tambah is checked
                                                                                newStock = originalStock + adjustmentAmount;
                                                                            } else if (cbKurang.checked && adjustmentAmount > 0) { // Recalculate if only kurang is checked
                                                                                 newStock = originalStock - adjustmentAmount;
                                                                            }


                                                                            stokBarangInput.value = newStock < 0 ? 0 : newStock;
                                                                        }
