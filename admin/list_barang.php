                    ...
                    <div class="theme-colors">
                        ...
                        <div class="flex switcher-style space-x-3 rtl:space-x-reverse">
                            <div class="hs-tooltip ti-main-tooltip ti-form-radio switch-select">
                                ...
                                <span class="hs-tooltip-content ti-main-tooltip-content !py-1 !px-2 !bg-black text-xs font-medium !text-white shadow-sm dark:!bg-black" role="tooltip">
                                    Light Menu
                                </span>
                            </div>
                            <div class="hs-tooltip ti-main-tooltip ti-form-radio switch-select">
                    ...
                    <ul class="header-content-right">
                            ...
                            <div class="main-header-dropdown hs-dropdown-menu ti-dropdown-menu hidden" data-popper-placement="none">
                                <div class="p-4">
                                    <div class="flex items-center justify-between">
                                        <p class="mb-0 text-[16px] font-medium">
                                            Notifications
                                        </p>
                                ...
                                <nav class="-mb-0.5 flex space-x-6 rtl:space-x-reverse px-3" role="tablist">
                                    <a
                                        class="hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-2 px-1 inline-flex items-center gap-2 border-b-[2px] border-transparent text-sm whitespace-nowrap text-defaulttextcolor dark:text-[#8c9097] dark:text-white/50 hover:text-primary dark:hover:!text-primary active"
                                        href="javascript:void(0);"
                                        id="underline-item-1"
                                    ...
                                    <a
                                        class="hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-2 px-1 inline-flex items-center gap-2 border-b-[2px] border-transparent text-sm whitespace-nowrap text-defaulttextcolor dark:text-[#8c9097] dark:text-white/50 hover:text-primary dark:hover:!text-primary"
                                        href="javascript:void(0);"
                                        id="underline-item-2"
                                    ...
                                    <div id="underline-1" role="tabpanel">
                                        <ul class="list-none mb-0" id="header-notification-scroll">
                                            <li class="ti-dropdown-item block">
                                                <div class="flex items-start">
                                                    <div class="pe-2 leading-none">
                                                        <span class="avatar avatar-md avatar-rounded svg-white">
                                            ...
                                            <li class="ti-dropdown-item block">
                                                <div class="flex items-start">
                                                    <div class="pe-2 leading-none">
                                                        <span class="avatar avatar-md bg-primary/10 !text-primary avatar-rounded svg-white">
                                                            SM
                                                        </span>
                                                    </div>
                                                    <div class="flex-grow-1 flex items-start justify-between">
                                            ...
                                            <li class="ti-dropdown-item block">
                                                <div class="flex items-start">
                                                    <div class="pe-2 leading-none">
                                                        <span class="avatar avatar-md bg-secondary-transparent avatar-rounded svg-white">
                                                            TR
                                                        </span>
                                                    </div>
                                                    <div class="flex-grow-1 flex items-start justify-between">
                                                        <div>
                                                            ...
                                                            <div class="font-normal text-[13px] header-notification-text truncate">
                                                                Peter has sent you a connection request, please check your connection requests.
                                                            </div>
                                    ...
                                    <div id="underline-2" class="hidden" role="tabpanel">
                                        <ul class="list-none mb-0" id="header-notification-scroll1">
                                                ...
                                                <div class="flex items-start">
                                                    <div class="pe-2 leading-none">
                                                        <span class="avatar avatar-md avatar-rounded bg-primary">
                                                            <i class="ri-file-text-line text-[16px]"></i>
                                                        </span>
                                                    </div>
                                                    <div class="flex-grow-1 flex items-start justify-between">
                                                        <div>
                                                            <p class="mb-0 font-semibold">
                                                                <a href="javascript:void(0);">This Month Notes Prepared</a>
                                                            </p>
                                                            <div class="font-normal text-[13px] header-notification-text truncate">
                                            ...
                                            <li class="ti-dropdown-item block">
                                                <div class="flex items-start">
                                                    <div class="pe-2 leading-none">
                                                        <span class="avatar avatar-md avatar-rounded bg-secondary"> <i class="ri-box-3-line text-[16px]"></i></span>
                                                    </div>
                                                    <div class="flex-grow-1 flex items-start justify-between">
                                                        <div>
                                                            <p class="mb-0 font-semibold">
                                                                <a href="javascript:void(0);">
                                                                    Order
                                                                    <span class="text-success">#54321</span>
                                                                    has been shipped.
                                                                </a>
                                                            </p>
                                                            <div class="font-normal text-[13px] header-notification-text truncate">
                                                                Order is on its way. You can track your shipment using the tracking number provided.
                                                            </div>
                                                            <span class="text-[13px] text-textmuted dark:text-textmuted/50">2 min ago</span>
                                                        </div>
                                                        <div>
                                                ...
                                                <div class="flex items-start">
                                                    <div class="pe-2 leading-none">
                                                        <span class="avatar avatar-md avatar-rounded bg-success">
                                                            <i class="ri-mail-open-line text-[16px]"></i>
                                                        </span>
                                                    </div>
                                                    <div class="flex-grow-1 flex items-start justify-between">
                                                        <div>
                                                            <p class="mb-0 font-semibold">
                                                                <a href="javascript:void(0);">A Email Will be sent to customer.</a>
                                                            </p>
                                                            <div class="font-normal text-[13px] header-notification-text truncate">
                                                                An email regarding your recent order will be sent to the customer shortly.
                                                            </div>
                                            ...
                                            <li class="ti-dropdown-item block">
                                                <div class="flex items-start">
                                                    ...
                                                    <div class="flex-grow-1 flex items-start justify-between">
                                                        <div>
                                                            <p class="mb-0 font-semibold">
                                                                <a href="javascript:void(0);">Payment Form Will be Activated.</a>
                                                            </p>
                                                            <div class="font-normal text-[13px] header-notification-text truncate">
                                                                The payment form will be activated shortly. Please ensure that all necessary details are correctly filled out to proceed with the payment process.
                                                            </div>
                                                ...
                                                <div class="flex items-start">
                                                    <div class="pe-2 leading-none">
                                                        <span class="avatar avatar-md avatar-rounded bg-warning">
                                                            <i class="ri-group-line text-[16px]"></i>
                                                        </span>
                                                    </div>
                                                    <div class="flex-grow-1 flex items-start justify-between">
                                                        <div>
                                                            <p class="mb-0 font-semibold">
                                                                <a href="javascript:void(0);">Meeting will be held tomorrow</a>
                                                            </p>
                                                            <div class="font-normal text-[13px] header-notification-text truncate">
                                    ...
                                    <div id="underline-3" class="hidden" role="tabpanel">
                                        <ul class="list-none mb-0" id="header-notification-scroll2">
                                                ...
                                                <div class="flex items-start">
                                                    <div class="pe-2 leading-none">
                                                        <span class="avatar avatar-md avatar-rounded bg-primary/10 !text-primary">
                                                            <i class="ri-mail-line text-[16px]"></i>
                                                        </span>
                                                    </div>
                                                    <div class="flex-grow-1 flex items-start justify-between">
                                                        <div>
                                                            <p class="mb-0 font-semibold">
                                                                <a href="javascript:void(0);">Mail Login with Different Device</a>
                                                            </p>
                                                            <div class="font-normal text-[13px] header-notification-text truncate">
                                            ...
                                            <li class="ti-dropdown-item block">
                                                <div class="flex items-start">
                                                    <div class="pe-2 leading-none">
                                                        <span class="avatar avatar-md avatar-rounded bg-secondary/10 !text-secondary"> <i class="ri-folder-warning-line text-[16px]"></i></span>
                                                    </div>
                                                    <div class="flex-grow-1 flex items-start justify-between">
                                                        <div>
                                                            <p class="mb-0 font-semibold">
                                                                <a href="javascript:void(0);">Your Subscription was expaired.</a>
                                                            </p>
                                                            <div class="font-normal text-[13px] header-notification-text truncate">
                                                                Your subscription has expired. Please renew your subscription to continue enjoying uninterrupted access to our services.
                                                            </div>
                                            ...
                                            <li class="ti-dropdown-item block">
                                                <div class="flex items-start">
                                                    <div class="pe-2 leading-none">
                                                        <span class="avatar avatar-md avatar-rounded bg-success/10 !text-success">
                                                            <i class="ri-database-2-line text-[16px]"></i>
                                                        </span>
                                                    </div>
                                                    <div class="flex-grow-1 flex items-start justify-between">
                                                        <div>
                                                            <p class="mb-0 font-semibold">
                                                                <a href="javascript:void(0);">Your storage space is running low.</a>
                                                            </p>
                                                            <div class="font-normal text-[13px] header-notification-text truncate">
                                                                Your storage space is running low. Please free up some space or upgrade your storage plan to avoid any interruptions.
                                                            </div>
                                            ...
                                            <li class="ti-dropdown-item block">
                                                <div class="flex items-start">
                                                    ...
                                                    <div class="flex-grow-1 flex items-start justify-between">
                                                        <div>
                                                            <p class="mb-0 font-semibold">
                                                                <a href="javascript:void(0);">Your changes have been saved.</a>
                                                            </p>
                                                            <div class="font-normal text-[13px] header-notification-text truncate">
                                                ...
                                                <div class="flex items-start">
                                                    <div class="pe-2 leading-none">
                                                        <span class="avatar avatar-md avatar-rounded bg-warning/10 !text-warning">
                                                            <i class="ri-stack-line text-[16px]"></i>
                                                        </span>
                                                    </div>
                                                    <div class="flex-grow-1 flex items-start justify-between">
                                                        <div>
                                                            <p class="mb-0 font-semibold">
                                                                <a href="javascript:void(0);">New updates are available soon.</a>
                                                            </p>
                                                            <div class="font-normal text-[13px] header-notification-text truncate">
                                                                Exciting new updates are on the way! Stay tuned for enhancements and new features that will be available soon.
                                                            </div>
                                                            <span class="text-[13px] text-textmuted dark:text-textmuted/50">2 days ago</span>
                                                        </div>
                                                        <div>
                        ...
                        <li class="header-element ti-dropdown hs-dropdown">
                            ...
                            <ul class="main-header-dropdown hs-dropdown-menu ti-dropdown-menu pt-0 overflow-hidden header-profile-dropdown hidden" aria-labelledby="mainHeaderProfile">
                                ...
                                <li>
                                    <a class="ti-dropdown-item flex items-center" href="profile.html"><i class="ti ti-user text-primary me-2 text-[1rem]"></i>Profile</a>
                                </li>
                                <li>
                                    <a class="ti-dropdown-item flex items-center" href="mail.html"><i class="ti ti-mail text-secondary me-2 text-[1rem]"></i> Inbox</a>
                                </li>
                                <li>
                                    <a class="ti-dropdown-item flex items-center" href="file-manager.html"><i class="ti ti-checklist text-success klist me-2 text-[1rem]"></i>Task Manger</a>
                                </li>
                                <li>
                                    <a class="ti-dropdown-item flex items-center" href="mail-settings.html"><i class="ti ti-settings text-info ings me-2 text-[1rem]"></i>Settings</a>
                                </li>
                                <li class="!border-t-0">
                                    <a class="ti-dropdown-item flex items-center" href="chat.html"><i class="ti ti-headset text-warning set me-2 text-[1rem]"></i>Support</a>
                                </li>
                                <li class="py-2 px-3">
                ...
                <div class="main-sidebar" id="sidebar-scroll">
                    ...
                    <nav class="main-menu-container nav nav-pills flex-col sub-open">
                        ...
                        <ul class="main-menu">
                            ...
                            <!-- Start::slide__category -->
                            <li class="slide__category">
                                <span class="category-name">Stok Barang</span>
                            </li>
                            <!-- End::slide__category -->
                            ...
                            <!-- Start::slide__category -->
                            <li class="slide__category">
                                <span class="category-name">Supplier</span>
                            </li>
                            <!-- End::slide__category -->
                        ...
                        <div class="xl:col-span-12 col-span-12">
                            <div class="box custom-box">
                                <div class="box-header">
                                    <div class="box-title">Fixed Header</div>
                                </div>
                                <div class="box-body">
            ...
            <footer class="mt-auto py-4 bg-white dark:bg-bodybg text-center border-t border-defaultborder dark:border-defaultborder/10">
                <div class="container">
                    <span class="text-textmuted dark:text-textmuted/50">
                        Copyright © <span id="year"></span> <a href="javascript:void(0);" class="text-dark font-medium dark:text-defaulttextcolor/80">Zynix</a>. Designed with <span class="bi bi-heart-fill text-danger"></span> by
                        ...
                        <div class="ti-modal-content">
                            <div class="ti-modal-body">
                                <div class="input-group">
                                    ...
                                    <button class="ti-btn ti-btn-primary !m-0" type="button" id="button-addon2">
