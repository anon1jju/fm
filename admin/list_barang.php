                            ...
                            <div class="box-header justify-between">
                                ...
                                <div class="flex gap-2">
                                    ...
                                    <div class="hs-overlay hidden ti-modal" id="modal-tambah-barang">
                                        <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 lg:mx-auto flex items-center min-h-[calc(100%-3.5rem)]">
                                                    ...
                                                    <form action="../prosesdata/process_tambah_barang.php" method="POST">
                                                        <div class="grid grid-cols-12 sm:gap-x-6 gap-y-3">
                                                            ...
                                                            <div class="xl:col-span-3 col-span-12">
                                                                ...
                                                                <select class="ti-form-control" name="category_id" required>
                                                                    <option value="1">Obat Bebas</option>
                                                                    <option value="2">Obat Bebas Terbatas</option>
                                                                    <option value="3">Obat Keras</option>
                                                                    <option value="4">Vitamin & Suplemen</option>
                                                                    <option value="5">Alat Kesehatan</option>
                                                                    <option value="6">Herbal</option>
                                                                    <!-- Pastikan value beda-beda -->
                                                                </select>
                                                            </div>
                                                            ...
                                                            <div class="xl:col-span-3 col-span-12">
                                                                ...
                                                                <!-- Lebih cocok pakai type="date" -->
                                                            </div>
                                                    
                                                            <!-- Batasan baru: -->
                                                            <div class="xl:col-span-3 col-span-12">
                                                                <label class="ti-form-label">Kode Item</label>
                                                                <input type="text" class="ti-form-control" name="kode_item">
                                                            </div>
                                                            ...
                                                            <div class="xl:col-span-3 col-span-12">
                                                                ...
                                                                <select class="ti-form-control" name="unit" required>
                                                            ...
                                                            <div class="xl:col-span-2 col-span-12">
                                                                ...
                                                                <!-- Sebelumnya stok_barang 2x, harusnya stok_minimum -->
                                                            </div>
                                    ...
                                    <table class="table border border-defaultborder dark:border-defaultborder/10 text-nowrap">
                                        ...
                                        <?php if (!empty($dataProduk)): ?> 
                                            ...
                                            <?php 
                                                ...
                                                $expire_produk = json_decode($farma->daysUntilExpire($produk['expire']), true);
                                            ...
                                            ?> <tr class="product-list border-b border-defaultborder dark:border-defaultborder/10">
                                                ...
                                                <td>
                                                    <div class="hstack gap-2 text-[15px]">
                                                        <a href="edit-products.php?id=<?php echo $produk['product_id']; ?>" class="ti-btn ti-btn-icon ti-btn-md ti-btn-soft-primary"><i class="ri-edit-line"></i></a>
                                                        <a href="delete-products.php?id=<?php echo $produk['product_id']; ?>" class="ti-btn ti-btn-icon ti-btn-md ti-btn-soft-danger product-btn"><i class="ri-delete-bin-line"></i></a>
                                                    </div>
                                                </td>
