                    ...
                    <div class="xl:col-span-12 col-span-12">
                        <div class="box">
                            <div class="box-header justify-between">
                                <div class="box-title"><i class="ri-team-line"></i></i>
                                    Daftar Users
                                </div>
                                <div class="flex gap-2">
                                
                                    <button type="button" class="hs-dropdown-toggle ti-btn ti-btn-sm !m-0 ti-btn-primary text-nowrap" data-hs-overlay="#hs-focus-management-modal"><i class="ri-add-fill"></i>Tambah Pengguna</button>
    ...
    <?php if (!empty($users)): ?>
        <?php foreach ($users as $user): ?>
            <tr class="product-list border-b border-defaultborder dark:border-defaultborder/10">
                ...
                <td>
                    <span class="text-[15px] badge <?= $user['role'] == 'admin' ? 'bg-success-transparent' : 'bg-info-transparent' ?>">
                ...
                <td>
                    <div class="hstack gap-2 text-[15px]">
                        ...
                        <!-- Tombol Delete -->
                        <a aria-label="anchor" href="delete-user.php?username=<?= urlencode($user['username']) ?>" class="ti-btn ti-btn-icon ti-btn-md ti-btn-soft-danger product-btn">
