        ...
        <div class="ti-offcanvas-body !p-0 !pb-[20rem] sm:!pb-[10rem]" id="switcher-body">
                ...
                <div class="">
                    ...
                    <div class="grid grid-cols-3 switcher-style">
                        <div class="flex items-center">
                            ...
                            <label for="switcher-light-theme" class="text-[0.813rem] text-defaulttextcolor dark:text-defaulttextcolor/80 ms-2 font-normal">Light</label>
                        </div>
                        <div class="flex items-center">
                            <input type="radio" name="theme-style" class="ti-form-radio" id="switcher-dark-theme">
                            <label for="switcher-dark-theme" class="text-[0.813rem] text-defaulttextcolor dark:text-defaulttextcolor/80 ms-2 font-normal">Dark</label>
                        </div>
                    </div>
                </div>
                <div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-3  switcher-style">
                        <div class="flex items-center">
                            ...
                            <label for="switcher-vertical" class="text-[0.813rem] text-defaulttextcolor dark:text-defaulttextcolor/80 ms-2  font-normal">Vertical</label>
                        </div>
                        <div class="flex items-center">
                            <input type="radio" name="navigation-style" class="ti-form-radio" id="switcher-horizontal">
                            <label for="switcher-horizontal" class="text-[0.813rem] text-defaulttextcolor dark:text-defaulttextcolor/80 ms-2  font-normal">Horizontal</label>
                        </div>
                    </div>
                </div>
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-2 switcher-style">
                        <div class="flex">
                            ...
                            <label for="switcher-menu-click" class="text-[0.813rem] text-defaulttextcolor dark:text-defaulttextcolor/80 ms-2  font-normal">Menu Click</label>
                        </div>
                        <div class="flex">
                            <input type="radio" name="navigation-data-menu-styles" class="ti-form-radio" id="switcher-menu-hover">
                            <label for="switcher-menu-hover" class="text-[0.813rem] text-defaulttextcolor dark:text-defaulttextcolor/80 ms-2  font-normal">Menu Hover</label>
                        </div>
                        <div class="flex">
                            <input type="radio" name="navigation-data-menu-styles" class="ti-form-radio" id="switcher-icon-click">
                            <label for="switcher-icon-click" class="text-[0.813rem] text-defaulttextcolor dark:text-defaulttextcolor/80 ms-2  font-normal">Icon Click</label>
                        </div>
                        <div class="flex">
                            <input type="radio" name="navigation-data-menu-styles" class="ti-form-radio" id="switcher-icon-hover">
                            <label for="switcher-icon-hover" class="text-[0.813rem] text-defaulttextcolor dark:text-defaulttextcolor/80 ms-2  font-normal">Icon Hover</label>
                        </div>
                    </div>
                </div>
                <div class=" sidemenu-layout-styles">
                    ...
                    <div class="grid grid-cols-2 gap-2 switcher-style">
                        <div class="flex">
                            ...
                            <label for="switcher-default-menu" class="text-[0.813rem] text-defaulttextcolor dark:text-defaulttextcolor/80 ms-2  font-normal ">Default Menu</label>
                        </div>
                        <div class="flex">
                            <input type="radio" name="sidemenu-layout-styles" class="ti-form-radio" id="switcher-closed-menu">
                            <label for="switcher-closed-menu" class="text-[0.813rem] text-defaulttextcolor dark:text-defaulttextcolor/80 ms-2  font-normal "> Closed Menu</label>
                        </div>
                        <div class="flex">
                            <input type="radio" name="sidemenu-layout-styles" class="ti-form-radio" id="switcher-icontext-menu">
                            <label for="switcher-icontext-menu" class="text-[0.813rem] text-defaulttextcolor dark:text-defaulttextcolor/80 ms-2  font-normal ">Icon Text</label>
                        </div>
                        <div class="flex">
                            <input type="radio" name="sidemenu-layout-styles" class="ti-form-radio" id="switcher-icon-overlay">
                            <label for="switcher-icon-overlay" class="text-[0.813rem] text-defaulttextcolor dark:text-defaulttextcolor/80 ms-2  font-normal ">Icon Overlay</label>
                        </div>
                        <div class="flex">
                            <input type="radio" name="sidemenu-layout-styles" class="ti-form-radio" id="switcher-detached">
                            <label for="switcher-detached" class="text-[0.813rem] text-defaulttextcolor dark:text-defaulttextcolor/80 ms-2  font-normal ">Detached</label>
                        </div>
                        <div class="flex">
                            <input type="radio" name="sidemenu-layout-styles" class="ti-form-radio" id="switcher-double-menu">
                            <label for="switcher-double-menu" class="text-[0.813rem] text-defaulttextcolor dark:text-defaulttextcolor/80 ms-2  font-normal">Double Menu</label>
                        </div>
                    </div>
                </div>
                <div>
                    ...
                    <div class="grid grid-cols-3  switcher-style">
                        <div class="flex">
                            ...
                            <label for="switcher-regular" class="text-[0.813rem] text-defaulttextcolor dark:text-defaulttextcolor/80 ms-2  font-normal">Regular</label>
                        </div>
                        <div class="flex">
                            <input type="radio" name="data-page-styles" class="ti-form-radio" id="switcher-classic">
                            <label for="switcher-classic" class="text-[0.813rem] text-defaulttextcolor dark:text-defaulttextcolor/80 ms-2  font-normal">Classic</label>
                        </div>
                        <div class="flex">
                            <input type="radio" name="data-page-styles" class="ti-form-radio" id="switcher-modern">
                            <label for="switcher-modern" class="text-[0.813rem] text-defaulttextcolor dark:text-defaulttextcolor/80 ms-2  font-normal"> Modern</label>
                        </div>
                    </div>
                </div>
                <div>
                    ...
                    <div class="grid grid-cols-3 switcher-style">
                        <div class="flex">
                            ...
                            <label for="switcher-full-width" class="text-[0.813rem] text-defaulttextcolor dark:text-defaulttextcolor/80 ms-2  font-normal">FullWidth</label>
                        </div>
                        <div class="flex">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-3  switcher-style">
                        <div class="flex">
                            ...
                            <label for="switcher-menu-fixed" class="text-[0.813rem] text-defaulttextcolor dark:text-defaulttextcolor/80 ms-2  font-normal">Fixed</label>
                        </div>
                        <div class="flex">
                            <input type="radio" name="data-menu-positions" class="ti-form-radio" id="switcher-menu-scroll">
                            <label for="switcher-menu-scroll" class="text-[0.813rem] text-defaulttextcolor dark:text-defaulttextcolor/80 ms-2  font-normal">Scrollable </label>
                        </div>
                    </div>
                </div>
                <div>
                    ...
                    <div class="grid grid-cols-3 switcher-style">
                        <div class="flex">
                            ...
                            <label for="switcher-header-fixed" class="text-[0.813rem] text-defaulttextcolor dark:text-defaulttextcolor/80 ms-2  font-normal"> Fixed</label>
                        </div>
                        <div class="flex">
                            <input type="radio" name="data-header-positions" class="ti-form-radio" id="switcher-header-scroll">
                            <label for="switcher-header-scroll" class="text-[0.813rem] text-defaulttextcolor dark:text-defaulttextcolor/80 ms-2  font-normal">Scrollable </label>
                        </div>
                    </div>
                </div>
                <div class="">
                    ...
                    <div class="grid grid-cols-3 switcher-style">
                        <div class="flex">
                            ...
                            <label for="switcher-loader-enable" class="text-[0.813rem] text-defaulttextcolor dark:text-defaulttextcolor/80 ms-2  font-normal"> Enable</label>
                        </div>
                        <div class="flex">
                            <input type="radio" name="page-loader" class="ti-form-radio" id="switcher-loader-disable">
                            <label for="switcher-loader-disable" class="text-[0.813rem] text-defaulttextcolor dark:text-defaulttextcolor/80 ms-2  font-normal">Disable </label>
                        </div>
                    </div>
                </div>
            </div>
            <div id="switcher-2" class="hidden" role="tabpanel" aria-labelledby="switcher-item-2">
                <div class="theme-colors">
                    ...
                    <div class="flex switcher-style space-x-3 rtl:space-x-reverse">
                        <div class="hs-tooltip ti-main-tooltip ti-form-radio switch-select ">
                            ...
                            <span class="hs-tooltip-content ti-main-tooltip-content !py-1 !px-2 !bg-black text-xs font-medium !text-white shadow-sm dark:!bg-black" role="tooltip"> Light Menu </span>
                        </div>
                        <div class="hs-tooltip ti-main-tooltip ti-form-radio switch-select ">
                            <input class="hs-tooltip-toggle ti-form-radio color-input color-dark" type="radio" name="menu-colors" id="switcher-menu-dark">
                            <span class="hs-tooltip-content ti-main-tooltip-content !py-1 !px-2 !bg-black text-xs font-medium !text-white shadow-sm dark:!bg-black" role="tooltip"> Dark Menu </span>
                        </div>
                        <div class="hs-tooltip ti-main-tooltip ti-form-radio switch-select ">
                            ...
                            <span class="hs-tooltip-content ti-main-tooltip-content !py-1 !px-2 !bg-black text-xs font-medium !text-white shadow-sm dark:!bg-black" role="tooltip"> Color Menu </span>
                        </div>
                        <div class="hs-tooltip ti-main-tooltip ti-form-radio switch-select ">
                            ...
                            <span class="hs-tooltip-content ti-main-tooltip-content !py-1 !px-2 !bg-black text-xs font-medium !text-white shadow-sm dark:!bg-black" role="tooltip"> Gradient Menu </span>
                        </div>
                        <div class="hs-tooltip ti-main-tooltip ti-form-radio switch-select ">
                            ...
                            <span class="hs-tooltip-content ti-main-tooltip-content !py-1 !px-2 !bg-black text-xs !font-medium !text-white shadow-sm dark:!bg-black" role="tooltip"> Transparent Menu </span>
                        </div>
                    </div>
                ...
                <div class="theme-colors">
                    ...
                    <div class="flex switcher-style space-x-3 rtl:space-x-reverse">
                        <div class="hs-tooltip ti-main-tooltip ti-form-radio switch-select ">
                            <input class="hs-tooltip-toggle ti-form-radio color-input color-white !border" type="radio" name="header-colors" id="switcher-header-light" checked>
                            <span class="hs-tooltip-content ti-main-tooltip-content !py-1 !px-2 !bg-black text-xs font-medium !text-white shadow-sm dark:!bg-black" role="tooltip"> Light Header </span>
                        </div>
                        <div class="hs-tooltip ti-main-tooltip ti-form-radio switch-select ">
                            <input class="hs-tooltip-toggle ti-form-radio color-input color-dark" type="radio" name="header-colors" id="switcher-header-dark">
                            <span class="hs-tooltip-content ti-main-tooltip-content !py-1 !px-2 !bg-black text-xs font-medium !text-white shadow-sm dark:!bg-black" role="tooltip"> Dark Header </span>
                        </div>
                        <div class="hs-tooltip ti-main-tooltip ti-form-radio switch-select ">
                            ...
                            <span class="hs-tooltip-content ti-main-tooltip-content !py-1 !px-2 !bg-black text-xs font-medium !text-white shadow-sm dark:!bg-black" role="tooltip"> Color Header </span>
                        </div>
                        <div class="hs-tooltip ti-main-tooltip ti-form-radio switch-select ">
                            ...
                            <span class="hs-tooltip-content ti-main-tooltip-content !py-1 !px-2 !bg-black text-xs font-medium !text-white shadow-sm dark:!bg-black" role="tooltip"> Gradient Header </span>
                        </div>
                        <div class="hs-tooltip ti-main-tooltip ti-form-radio switch-select ">
                            ...
                            <span class="hs-tooltip-content ti-main-tooltip-content !py-1 !px-2 !bg-black text-xs font-medium !text-white shadow-sm dark:!bg-black" role="tooltip"> Transparent Header </span>
                        </div>
                    </div>
                ...
                <div class="theme-colors">
                    ...
                    <div class="flex switcher-style space-x-3 rtl:space-x-reverse">
                        <div class="ti-form-radio switch-select">
                            <input class="ti-form-radio color-input color-bg-1" type="radio" name="theme-background" id="switcher-background">
                        </div>
                        <div class="ti-form-radio switch-select">
            ...
            <div class="main-header-container container-fluid">
                ...
                <div class="header-content-left">
                    ...
                    <div class="header-element lg:mx-0">
                        <a aria-label="Hide Sidebar" class="sidemenu-toggle hor-toggle horizontal-navtoggle header-link" data-bs-toggle="sidebar" href="javascript:void(0);">
                            <span>
                ...
                <ul class="header-content-right">
                    ...
                    <li class="header-element search-dropdown hs-dropdown ti-dropdown md:!block !hidden [--placement:bottom-right] rtl:[--placement:bottom-left] [--auto-close:inside]">
                        ...
                        <ul class="main-header-dropdown hs-dropdown-menu ti-dropdown-menu hidden overflow-visible" data-popper-placement="none">
                            <li class="px-3 py-2">
                    ...
                    <li class="header-element header-theme-mode hidden !items-center sm:block md:!px-[0.5rem] px-2">
                        <a aria-label="anchor" class="hs-dark-mode-active:hidden flex hs-dark-mode group flex-shrink-0 justify-center items-center gap-2  rounded-full font-medium transition-all text-xs dark:bg-bgdark dark:hover:bg-black/20 text-textmuted dark:text-textmuted/50 dark:hover:text-white dark:focus:ring-white/10 dark:focus:ring-offset-white/10" href="javascript:void(0);" data-hs-theme-click-value="dark">
                            <svg xmlns="http://www.w3.org/2000/svg" class="header-link-icon" viewBox="0 0 256 256">
                                ...
                                <path d="M108.11,28.11A96.09,96.09,0,0,0,227.89,147.89,96,96,0,1,1,108.11,28.11Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></path>
                            </svg>
                        </a>
                        <a aria-label="anchor" class="hs-dark-mode-active:flex hidden hs-dark-mode group flex-shrink-0 justify-center items-center gap-2  rounded-full font-medium text-defaulttextcolor  transition-all text-xs dark:bg-bodybg dark:bg-bgdark dark:hover:bg-black/20  dark:hover:text-white dark:focus:ring-white/10 dark:focus:ring-offset-white/10" href="javascript:void(0);" data-hs-theme-click-value="light">
                            <svg xmlns="http://www.w3.org/2000/svg" class="header-link-icon" viewBox="0 0 256 256">
                                <rect width="256" height="256" fill="none"></rect>
                                <line x1="128" y1="40" x2="128" y2="32" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></line>
                                ...
                                <line x1="64" y1="64" x2="56" y2="56" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></line>
                                <line x1="64" y1="192" x2="56" y2="200" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></line>
                                <line x1="192" y1="64" x2="200" y2="56" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></line>
                                <line x1="192" y1="192" x2="200" y2="200" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></line>
                                <line x1="40" y1="128" x2="32" y2="128" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></line>
                                <line x1="128" y1="216" x2="128" y2="224" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></line>
                                <line x1="216" y1="128" x2="224" y2="128" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></line>
                            </svg>
                        </a>
                    </li>
                    ...
                    <li class="header-element notifications-dropdown !block hs-dropdown ti-dropdown [--auto-close:inside]">
                        ...
                        <a aria-label="anchor" href="javascript:void(0);" class="header-link hs-dropdown-toggle ti-dropdown-toggle" data-bs-toggle="dropdown" data-bs-auto-close="outside" id="messageDropdown" aria-expanded="false">
                            <svg xmlns="http://www.w3.org/2000/svg" class="header-link-icon animate-bell" viewBox="0 0 256 256">
                                ...
                                <path d="M184,24a102.71,102.71,0,0,1,36.29,40" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></path>
                                <path d="M35.71,64A102.71,102.71,0,0,1,72,24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></path>
                                <path d="M56,112a72,72,0,0,1,144,0c0,35.82,8.3,56.6,14.9,68A8,8,0,0,1,208,192H48a8,8,0,0,1-6.88-12C47.71,168.6,56,147.81,56,112Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></path>
                            </svg>
                            ...
                            <div>
                                    ...
                                    <ul class="list-none mb-0" id="header-notification-scroll">
                                        <li class="ti-dropdown-item block">
                                            <div class="flex items-start">
                                                <div class="pe-2 leading-none"> <span class="avatar avatar-md avatar-rounded svg-white">
                                                ...
                                                <div class="flex-grow-1 flex items-start justify-between">
                                                    <div>
                                                        ...
                                                        <div class="font-normal text-[13px] header-notification-text truncate"> Congratulations on snagging the Monthly Best Seller Gold Badge !</div>
                                                        <span class="text-textmuted dark:text-textmuted/50 text-xs">2 Min Ago</span>
                                                    </div>
                                                    <div> <a aria-label="anchor" href="javascript:void(0);" class="min-w-fit-content text-textmuted dark:text-textmuted/50 dropdown-item-close1"><i class="ri-close-line fs-5"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="ti-dropdown-item block">
                                            <div class="flex items-start">
                                                <div class="pe-2 leading-none"> <span class="avatar avatar-md bg-primary/10 !text-primary avatar-rounded svg-white"> SM </span>
                                                </div>
                                                <div class="flex-grow-1 flex items-start justify-between">
                                                    <div>
                                                        <p class="mb-0 font-semibold">You’ve Got Mail!</p>
                                                        <div class="font-normal text-[13px] header-notification-text truncate"> Natalie has sent you a new message. Click here to view it.</div>
                                                        <span class="text-textmuted dark:text-textmuted/50 text-xs">5 Min Ago</span>
                                                    </div>
                                                    <div> <a aria-label="anchor" href="javascript:void(0);" class="min-w-fit-content text-textmuted dark:text-textmuted/50 dropdown-item-close1"><i class="ri-close-line fs-5"></i></a>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="flex items-start">
                                                ...
                                                <div class="flex-grow-1 flex items-start justify-between">
                                                    <div>
                                                        ...
                                                        <div class="font-normal text-[13px] header-notification-text truncate"> Congratulations! Your project application has been approved.</div>
                                        ...
                                        <li class="ti-dropdown-item block">
                                            <div class="flex items-start">
                                                <div class="pe-2 leading-none"> <span class="avatar avatar-md bg-secondary-transparent avatar-rounded svg-white"> TR </span>
                                                </div>
                                                <div class="flex-grow-1 flex items-start justify-between">
                                                    <div>
                                                        <p class="mb-0 font-semibold">New Connection Request</p>
                                                        <div class="font-normal text-[13px] header-notification-text truncate"> Peter has sent you a connection request, please check your connection requests.</div>
                                            ...
                                            <div class="flex items-start">
                                                ...
                                                <div class="flex-grow-1 flex items-start justify-between">
                                                    <div>
                                                        ...
                                                        <div class="font-normal text-[13px] header-notification-text truncate"> Great news! Your order is now on its way to you.</div>
                                ...
                                <div id="underline-2" class="hidden" role="tabpanel">
                                    <ul class="list-none mb-0" id="header-notification-scroll1">
                                        <li class="ti-dropdown-item block">
                                            <div class="flex items-start">
                                                <div class="pe-2 leading-none"> <span class="avatar avatar-md avatar-rounded bg-primary">
                                                        <i class="ri-file-text-line text-[16px]"></i> </span>
                                                </div>
                                                <div class="flex-grow-1 flex items-start justify-between">
                                                    <div>
                                                        <p class="mb-0 font-semibold"><a href="javascript:void(0);">This Month Notes Prepared</a></p>
                                                        <div class="font-normal text-[13px] header-notification-text truncate"> Your notes for this month are ready and available. Please review them at your convenience.</div>
                                                        <span class="text-[13px] text-textmuted dark:text-textmuted/50">2 min ago</span>
                                                    </div>
                                                    <div>
                                                        <a aria-label="anchor" href="javascript:void(0);" class="min-w-fit-content text-textmuted dark:text-textmuted/50 dropdown-item-close1"><i class="ri-close-line fs-5"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="ti-dropdown-item block">
                                            <div class="flex items-start">
                                                <div class="pe-2 leading-none"> <span class="avatar avatar-md avatar-rounded bg-secondary">
                                                        <i class="ri-box-3-line text-[16px]"></i></span>
                                                </div>
                                                <div class="flex-grow-1 flex items-start justify-between">
                                                    <div>
                                                        <p class="mb-0 font-semibold"><a href="javascript:void(0);">Order <span class="text-success">#54321</span> has been shipped.</a></p>
                                                        <div class="font-normal text-[13px] header-notification-text truncate"> Order is on its way. You can track your shipment using the tracking number provided.</div>
                                                        <span class="text-[13px] text-textmuted dark:text-textmuted/50">2 min ago</span>
                                                    </div>
                                                    <div> <a aria-label="anchor" href="javascript:void(0);" class="min-w-fit-content text-textmuted dark:text-textmuted/50 dropdown-item-close1"><i class="ri-close-line fs-5"></i></a>
                                                    </div>
                                        ...
                                        <li class="ti-dropdown-item block">
                                            <div class="flex items-start">
                                                <div class="pe-2 leading-none"> <span class="avatar avatar-md avatar-rounded bg-success">
                                                        <i class="ri-mail-open-line text-[16px]"></i> </span>
                                                </div>
                                                <div class="flex-grow-1 flex items-start justify-between">
                                                    <div>
                                                        <p class="mb-0 font-semibold"><a href="javascript:void(0);">A Email Will be sent to customer.</a></p>
                                                        <div class="font-normal text-[13px] header-notification-text truncate"> An email regarding your recent order will be sent to the customer shortly.</div>
                                        ...
                                        <li class="ti-dropdown-item block">
                                            <div class="flex items-start">
                                                ...
                                                <div class="flex-grow-1 flex items-start justify-between">
                                                    <div>
                                                        <p class="mb-0 font-semibold"><a href="javascript:void(0);">Payment Form Will be Activated.</a></p>
                                                        <div class="font-normal text-[13px] header-notification-text truncate"> The payment form will be activated shortly. Please ensure that all necessary details are correctly filled out to proceed with the payment process.</div>
                                        ...
                                        <li class="ti-dropdown-item block">
                                            <div class="flex items-start">
                                                <div class="pe-2 leading-none"> <span class="avatar avatar-md avatar-rounded bg-warning">
                                                        <i class="ri-group-line text-[16px]"></i> </span>
                                                </div>
                                                <div class="flex-grow-1 flex items-start justify-between">
                                                    <div>
                                                        <p class="mb-0 font-semibold"><a href="javascript:void(0);">Meeting will be held tomorrow</a></p>
                                                        <div class="font-normal text-[13px] header-notification-text truncate"> This is a reminder that a meeting will be held tomorrow. </div>
                                ...
                                <div id="underline-3" class="hidden" role="tabpanel">
                                    <ul class="list-none mb-0" id="header-notification-scroll2">
                                        <li class="ti-dropdown-item block">
                                            <div class="flex items-start">
                                                <div class="pe-2 leading-none"> <span class="avatar avatar-md avatar-rounded bg-primary/10 !text-primary">
                                                        <i class="ri-mail-line text-[16px]"></i> </span>
                                                </div>
                                                <div class="flex-grow-1 flex items-start justify-between">
                                                    <div>
                                                        <p class="mb-0 font-semibold"><a href="javascript:void(0);">Mail Login with Different Device</a></p>
                                                        <div class="font-normal text-[13px] header-notification-text truncate"> Your email account has been accessed from a new device. If this was you, no action is needed. </div>
                                                        <span class="text-[13px] text-textmuted dark:text-textmuted/50">2 min ago</span>
                                                    </div>
                                                    <div> <a aria-label="anchor" href="javascript:void(0);" class="min-w-fit-content text-textmuted dark:text-textmuted/50 dropdown-item-close1"><i class="ri-close-line fs-5"></i></a>
                                                    </div>
                                        ...
                                        <li class="ti-dropdown-item block">
                                            <div class="flex items-start">
                                                <div class="pe-2 leading-none"> <span class="avatar avatar-md avatar-rounded bg-secondary/10 !text-secondary">
                                                        <i class="ri-folder-warning-line text-[16px]"></i></span>
                                                </div>
                                                <div class="flex-grow-1 flex items-start justify-between">
                                                    <div>
                                                        <p class="mb-0 font-semibold"><a href="javascript:void(0);">Your Subscription was expaired.</a></p>
                                                        <div class="font-normal text-[13px] header-notification-text truncate"> Your subscription has expired. Please renew your subscription to continue enjoying uninterrupted access to our services. </div>
                                        ...
                                        <li class="ti-dropdown-item block">
                                            <div class="flex items-start">
                                                <div class="pe-2 leading-none"> <span class="avatar avatar-md avatar-rounded bg-success/10 !text-success">
                                                        <i class="ri-database-2-line text-[16px]"></i> </span>
                                                </div>
                                                <div class="flex-grow-1 flex items-start justify-between">
                                                    <div>
                                                        <p class="mb-0 font-semibold"><a href="javascript:void(0);">Your storage space is running low.</a></p>
                                                        <div class="font-normal text-[13px] header-notification-text truncate"> Your storage space is running low. Please free up some space or upgrade your storage plan to avoid any interruptions. </div>
                                        ...
                                        <li class="ti-dropdown-item block">
                                            <div class="flex items-start">
                                                <div class="pe-2 leading-none"> <span class="avatar avatar-md avatar-rounded bg-info/10 !text-info">
                                                        <i class="ri-bank-card-line text-[16px]"></i> </span>
                                                </div>
                                                <div class="flex-grow-1 flex items-start justify-between">
                                                    <div>
                                                        <p class="mb-0 font-semibold"><a href="javascript:void(0);">Your changes have been saved.</a></p>
                                                        <div class="font-normal text-[13px] header-notification-text truncate"> Your changes have been saved. If you need to make any more adjustments, feel free to do so. </div>
                                                        <span class="text-[13px] text-textmuted dark:text-textmuted/50">Yesterday</span>
                                                    </div>
                                                    <div> <a aria-label="anchor" href="javascript:void(0);" class="min-w-fit-content text-textmuted dark:text-textmuted/50 dropdown-item-close1"><i class="ri-close-line fs-5"></i></a>
                                                    </div>
                                        ...
                                        <li class="ti-dropdown-item block">
                                            <div class="flex items-start">
                                                <div class="pe-2 leading-none"> <span class="avatar avatar-md avatar-rounded bg-warning/10 !text-warning">
                                                        <i class="ri-stack-line text-[16px]"></i> </span>
                                                </div>
                                                <div class="flex-grow-1 flex items-start justify-between">
                                                    <div>
                                                        <p class="mb-0 font-semibold"><a href="javascript:void(0);">New updates are available soon.</a></p>
                                                        <div class="font-normal text-[13px] header-notification-text truncate"> Exciting new updates are on the way! Stay tuned for enhancements and new features that will be available soon. </div>
                                                        <span class="text-[13px] text-textmuted dark:text-textmuted/50">2 days ago</span>
                                                    </div>
                                                    <div>
                                                        <a aria-label="anchor" href="javascript:void(0);" class="min-w-fit-content text-textmuted dark:text-textmuted/50 dropdown-item-close1">
                    ...
                    <li class="header-element header-fullscreen">
                        ...
                        <a aria-label="anchor" onclick="openFullscreen();" href="javascript:void(0);" class="header-link">
                            <svg xmlns="http://www.w3.org/2000/svg" class="full-screen-open header-link-icon block" viewBox="0 0 256 256">
                                <rect width="256" height="256" fill="none"></rect>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="full-screen-close header-link-icon hidden" viewBox="0 0 256 256">
                                <rect width="256" height="256" fill="none"></rect>
                    ...
                    <li class="header-element ti-dropdown hs-dropdown">
                        <!-- Start::header-link|dropdown-toggle -->
                        <a href="javascript:void(0);" class="header-link hs-dropdown-toggle ti-dropdown-toggle dropdown-profile" id="mainHeaderProfile" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                            <div class="flex items-center">
                                ...
                                <div class="xl:block hidden leading-none">
                                    <span class="font-medium leading-none dark:text-defaulttextcolor/70">
                        ...
                        <ul class="main-header-dropdown hs-dropdown-menu ti-dropdown-menu pt-0 overflow-hidden header-profile-dropdown hidden" aria-labelledby="mainHeaderProfile">
                            <li>
                                <div class="py-2 px-4 text-center block">
                                    <span class="font-semibold"> Mr.Jack Miller </span>
                                    <span class="block text-xs text-textmuted dark:text-textmuted/50">UI/UX Designer</span>
                                </div>
                            </li>
                            <li><a class="ti-dropdown-item flex items-center" href="profile.html"><i class="ti ti-user text-primary me-2 text-[1rem]"></i>Profile</a>
                            </li>
                            <li><a class="ti-dropdown-item flex items-center" href="mail.html"><i class="ti ti-mail text-secondary me-2 text-[1rem]"></i> Inbox</a></li>
                            <li><a class="ti-dropdown-item flex items-center" href="file-manager.html"><i class="ti ti-checklist text-success klist me-2 text-[1rem]"></i>Task Manger</a></li>
                            <li><a class="ti-dropdown-item flex items-center" href="mail-settings.html"><i class="ti ti-settings text-info ings me-2 text-[1rem]"></i>Settings</a>
                            </li>
                            <li class="!border-t-0 "><a class="ti-dropdown-item flex items-center" href="chat.html"><i class="ti ti-headset text-warning set me-2 text-[1rem]"></i>Support</a>
                            </li>
                            <li class="py-2 px-3 ">
            ...
            <div class="main-sidebar" id="sidebar-scroll">
                ...
                <nav class="main-menu-container nav nav-pills flex-col sub-open">
                    ...
                    <ul class="main-menu">
                        ...
                        <li class="slide has-sub">
                            <a href="javascript:void(0);" class="side-menu__item">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 256 256">
                                    ...
                                    <path d="M104,216V152h48v64h64V120a8,8,0,0,0-2.34-5.66l-80-80a8,8,0,0,0-11.32,0l-80,80A8,8,0,0,0,40,120v96Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16" />
                                </svg>
                        ...
                        <li class="slide has-sub">
                            <a href="javascript:void(0);" class="side-menu__item">
                                <svg class="h-5 w-5 text-gray-700 mr-2" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <div class="xl:col-span-12 col-span-12">
                        <div class="box">
                            <div class="box-header justify-between">
                                <div class="box-title"><i class="ri-team-line"></i></i> Daftar Users </div>
                                <div class="flex gap-2">
                                    <button type="button" class="hs-dropdown-toggle ti-btn ti-btn-md !m-0 ti-btn-primary text-nowrap" data-hs-overlay="#hs-focus-management-modal"><i class="ri-add-fill"></i>Tambah Pengguna</button>
                                    <div id="hs-focus-management-modal" class="hs-overlay hidden ti-modal shadow-md">
                                        <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out">
                                            <div class="ti-modal-content">
                                                <div class="ti-modal-header">
                                                    <h4 class="ti-modal-title"><i class="ri-user-add-line"></i>Tambah Pengguna</h4>
                                                    <button type="button" class="hs-dropdown-toggle ti-modal-close-btn" data-hs-overlay="#hs-focus-management-modal">
                                                        ...
                                                        <svg class="w-3.5 h-3.5" width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M0.258206 1.00652C0.351976 0.912791 0.479126 0.860131 0.611706 0.860131C0.744296 0.860131 0.871447 0.912791 0.965207 1.00652L3.61171 3.65302L6.25822 1.00652C6.30432 0.958771 6.35952 0.920671 6.42052
                                                                    ...
                                                                    4.36002L0.258206 1.71352C0.164476 1.61976 0.111816 1.4926 0.111816 1.36002C0.111816 1.22744 0.164476 1.10028 0.258206 1.00652Z" fill="currentColor"></path>
                                                        </svg>
                                                    </button>
                                                </div>
                                                <form method="POST" action="../prosesdata/process_tambah_user.php">
                                                    <div class="ti-modal-body">
                                                        <label for="nama_pengguna" class="ti-form-label text-sm">Nama Pengguna</label>
                                                        <input type="text" name="nama_pengguna" id="nama_pengguna" class="ti-form-input text-md py-2" required />
                                                    </div>
                                                    <div class="ti-modal-body">
                                                        <label for="username" class="ti-form-label text-sm">Username</label>
                                                        <input type="text" name="username" id="username" class="ti-form-input text-md py-2" required />
                                                    </div>
                                                    <div class="ti-modal-body">
                                                        <label for="password" class="ti-form-label text-sm mb-1">Password</label>
                                                        <input type="text" name="password" id="password" class="ti-form-input text-md py-2" required />
                                                    </div>
                                                    <div class="ti-modal-body">
                                                        <label for="hak_akses" class="ti-form-label text-sm mb-1">Hak Akses</label>
                                                        <select name="hak_akses" id="hak_akses" class="ti-form-input text-md py-2" required>
                                    ...
                                    <table class="table border border-defaultborder dark:border-defaultborder/10 text-nowrap">
                                        <thead>
                                            <tr class="border-b border-defaultborder dark:border-defaultborder/10">
                                                ...
                                                <th scope="col">Tanggal Register User</th>
                                                <th scope="col">Aksi</th>
                                            </tr>
                                        </thead>
                                        <tbody> <?php if (!empty($users)): ?> <?php foreach ($users as $user): ?> <tr class="product-list border-b border-defaultborder dark:border-defaultborder/10">
                                                <td><?= htmlspecialchars($user['username']) ?></td>
                                                <td><?= htmlspecialchars($user['name']) ?></td>
                                                <td>
                                                    <span class="text-[13px] badge <?= $user['role'] == 'admin' ? 'bg-success-transparent' : 'bg-info-transparent' ?>"> <?= htmlspecialchars($user['role']) ?> </span>
                                                </td>
                                                <td><?= $user['last_login'] ? htmlspecialchars(date('d-m-Y H:i:s', strtotime($user['last_login']))) : '-' ?></td>
                                                <td><?= htmlspecialchars(date('d-m-Y H:i:s', strtotime($user['created_at']))) ?></td>
                                                <td>
                                                    <div class="hstack gap-2 text-[15px]">
                                                        <!-- Tombol Edit -->
                                                        <a aria-label="anchor" class="edit-dropdown-toggle ti-btn ti-btn-icon ti-btn-md ti-btn-soft-primary" data-hs-overlay="#edit-user-modal-<?= htmlspecialchars($user['username']) ?>">
                                                            <i class="ri-edit-line"></i>
                                                        </a>
                                                        <!-- Modal Edit -->
                                                        <div id="edit-user-modal-<?= htmlspecialchars($user['username']) ?>" class="hs-overlay hidden ti-modal shadow-md">
                                                            <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out">
                                                                <div class="ti-modal-content">
                                                                    <div class="ti-modal-header">
                                                                        <h4 class="ti-modal-title"><i class="ri-edit-line"></i> Edit Pengguna</h4>
                                                                        <button type="button" class="edit-dropdown-toggle ti-modal-close-btn" data-hs-overlay="#edit-user-modal-<?= htmlspecialchars($user['username']) ?>">
                                                                            <span class="sr-only">Close</span>
                                                                            <svg class="w-3.5 h-3.5" width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                <path d="M0.258206 1.00652C0.351976 0.912791 0.479126 0.860131 0.611706 0.860131C0.744296 0.860131 0.871447 0.912791 0.965207 1.00652L3.61171 3.65302L6.25822 1.00652C6.30432 0.958771 6.35952 0.920671 6.42052
                                                                                            0.894471C6.48152 0.868271 6.54712 0.854471 6.61352 0.853901C6.67992 0.853321 6.74572 0.865971 6.80722 0.891111C6.86862 0.916251 6.92442 0.953381 6.97142 1.00032C7.01832 1.04727 7.05552 1.1031 7.08062
                                                                    ...
                                                                    <form method="POST" action="../prosesdata/process_edit_user.php">
                                                                        ...
                                                                        <div class="ti-modal-footer">
                                                                            <button type="button" class="hs-dropdown-toggle ti-btn btn-wave ti-btn-danger" data-hs-overlay="#edit-user-modal-<?= htmlspecialchars($user['username']) ?>">Tutup</button>
                                                                            <button type="submit" class="ti-btn btn-wave ti-btn-success">Simpan</button>
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                        ...
                                                        <!-- Tombol Delete -->
                                                        <a aria-label="anchor" href="javascript:void(0);" class="ti-btn ti-btn-icon ti-btn-md ti-btn-soft-danger product-btn delete-user-btn" data-username="<?= htmlspecialchars($user['username'], ENT_QUOTES, 'UTF-8') ?>">
        ...
        <footer class="mt-auto py-4 bg-white dark:bg-bodybg text-center border-t border-defaultborder dark:border-defaultborder/10">
            <div class="container">
                <span class="text-textmuted dark:text-textmuted/50">
                    <span id="year"></span> Developed by <a href="javascript:void(0);" class="text-dark font-medium dark:text-defaulttextcolor/80">Afra</a>. <a href="#" target="_blank">
        ...
        <script>
            ...
            document.querySelectorAll('.delete-user-btn').forEach((button) => {
                button.addEventListener('click', function() {
                    const username = this.getAttribute('data-username'); // Ambil username dari atribut data-username
                    // Tampilkan SweetAlert konfirmasi
                    Swal.fire({
                        title: `Apakah Anda yakin menghapus "${username}"?`, // Gunakan template literal langsung
                        text: `Pengguna dengan username tersebut akan dihapus!`,
                        icon: 'warning',
                        ...
                        if (result.isConfirmed) {
                            // Lakukan sesuatu jika di konfirmasi
                            window.location.href = `../prosesdata/process_delete_user.php?username=${encodeURIComponent(username)}`;
                        }
                    });
                });
            });
