...
<head>
    ...
    <style>
        ...
        #search-results-container { 
            ...
            border-top: none; 
            border-radius: 0 0 0.375rem 0.375rem; /* Rounded bottom */
        ...
        /* Styling untuk setiap item list di dropdown */
        /* Class .search-result-item digunakan di JS, bisa di-style di sini atau langsung dengan Tailwind di JS */
        /* Contoh jika ingin override atau tambah style spesifik: */
        /*
        .search-result-item {
            padding: 10px 12px;
            cursor: pointer;
...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto p-4 max-w-6xl"> <!-- Desain Container Asli Anda -->
        <!-- Header -->
        <div class="flex justify-between items-center mb-4">
            <div class="font-bold text-xl text-gray-800">Farma Medika</div>
            <div class="text-sm text-gray-600">
                <div>Kasir: <span id="cashier-name-display"><? echo $_SESSION["username"]?></span></div>
                <div>Tanggal: <span id="current-date"></span></div>
            </div>
        </div>
        ...
        <div class="space-y-4">
            ...
            <div class="fixed top-0 left-0 right-0 z-20 bg-gray-100 p-4 shadow"> <!-- z-index dinaikkan -->
                <div class="container mx-auto max-w-6xl">
                    ...
                    <div class="bg-indigo-700 rounded-lg p-4 text-white flex justify-between items-center mb-4">
                        <div>
                            ...
                            <!-- ID #grand-total penting untuk cashier.js -->
                            <div class="text-4xl font-bold" id="grand-total">Rp 0</div>
                            <!-- Jika ada sticky total, pastikan ID nya juga dikenali cashier.js -->
                            <!-- <div class="text-4xl font-bold" id="sticky-grand-total-display">Rp 0</div> -->
                        </div>
                    ...
                    <div class="grid grid-cols-3 gap-3">
                        <button id="process-payment-btn" disabled class="bg-blue-500 hover:bg-blue-600 text-white py-3 px-4 rounded-lg font-medium transition-colors">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                        <div>
                            ...
                            <select id="doctor-id" name="doctor_id" class="mt-0.5 block w-full pl-3 pr-10 py-1.5 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md">
                                ...
                                <option value="1">Dr. Budi Santoso</option> <!-- Placeholder, isi dari DB -->
                            </select>
                        </div>
                        <div>
    ...
    <div id="success-modal" class="fixed inset-0 hidden bg-black bg-opacity-70 flex items-center justify-center z-[100]">
        <div class="bg-white rounded-lg p-6 max-w-sm w-full mx-4">
            <div class="text-center">
                ...
                <p id="success-invoice" class="text-lg font-semibold mb-4">INV/XXXX/XX/XXX</p>
